...
public class TestConvertJSONToSQLCoverage {
  ...
  public void testCreateSqlStringValueWithTimestamp() throws IOException {
    ...
    String result = ConvertJSONToSQL.createSqlStringValue(node.get("created_at"), 26,
        Types.TIMESTAMP);
  ...
  // Helper methods
  private void testSqlValue(String jsonValue, int sqlType, String expectedResult)
      throws IOException {
